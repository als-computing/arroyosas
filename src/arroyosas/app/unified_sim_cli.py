...
def main(
    ...
    async def run():
        ...
        if mode == "db_replay":
            ...
            logger.info(f"DB replay mode with:")
            ...
            logger.info(f"Local tiled mode with:")
            ...
            logger.info(f"Direct mode with:")
            logger.info(f"- Tiled URI: {tiled_uri}")
            logger.info(f"- Cycles: {cycles}")
            logger.info(f"- Frames: {frames}")
            logger.info(f"- API key is not needed for public tiled dataset.")
