...
class Pilatus1M_SMI(Pilatus1M):
    ...
    def calc_mask(self, bs=None, bs_kind=None, optional_mask=None):
        ...
        mask[870, 544], mask[871, 545], mask[871, 546], mask[871, 547] = (
            False,
            False,
            False,
            False,
...
class VerticalPilatus300kw(Pilatus300kw):
    ...
    def calc_mask(self, bs, bs_kind=None, optional_mask=None):
        ...
        mask[486, :], mask[494, :], mask[980, :], mask[988, :] = (
            False,
            False,
            False,
            False,
        ...
        # Hot pixels
        mask[1314, 81] = False
        mask[732, 7], mask[732, 8], mask[733, 8], mask[733, 7], mask[733, 9] = (
            False,
            False,
            False,
            False,
        ...
        mask[674, 133], mask[674, 134], mask[1130, 20], mask[1239, 50] = (
            False,
            False,
            False,
            False,
