...
from ..schemas import GISAXSRawEvent, SerializableNumpyArrayModel
...
def start() -> None:
    ...
    while True:
        try:
            ...
            return_message = {"ls": latent_space.tobytes()}
            client_socket.send(msgpack.packb(return_message, use_bin_type=True))
